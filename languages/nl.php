...
l::set('uniform-default-subject', 'Bericht van het webformulier');
l::set('uniform-send-success', 'Hartelijk dank, het formulier is succesvol verzonden.');
l::set('uniform-send-error', 'Er is een fout bij het verzenden van het formulier opgetreden:');
