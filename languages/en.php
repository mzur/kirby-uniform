...
l::set('uniform-default-subject', 'Message from the web form');
l::set('uniform-send-success', 'Thank you, the form was sent successfully.');
l::set('uniform-send-error', 'There was an error sending the form:');
