...
Kirby::plugin('mzur/uniform', [
    ...
    'translations' => [
        ...
        'pt_PT' => [
            ...
            'uniform-login-error' => 'Utilizador ou palavra-passe incorretos.',
            'uniform-webhook-error' => 'Ocorreu um erro ao chamar o webhook: ',
            'uniform-email-select-error' => 'Destinatário inválido.',
            'uniform-upload-mkdir-fail' => 'Não foi possível criar a pasta de destino.',
            'uniform-upload-exists' => 'O ficheiro já existe.',
            'uniform-upload-failed' => 'Não foi possível enviar o ficheiro.',
            'uniform-honeytime-reject' => 'O formulário foi submetido demasiado rapidamente e ativou a proteção contra spam.',
            'uniform-honeytime-invalid' => 'Os dados do formulário eram inválidos e ativaram a proteção contra spam.',
        ],
        'ro' => [
